...
use App\SuiteComponents\EquipmentLineItemSuite;

class EquipmentLineItemController extends Controller
{
    /**
    ...
    {
        //
          $line_suite = new EquipmentLineItemSuite();
        //
        //array_map([$this, ])
    ...
    {
        //
         $labour_lineitemsuite = new EquipmentLineItemSuite();
